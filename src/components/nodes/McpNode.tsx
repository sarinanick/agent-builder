...
export default function McpNode({ id, data, selected }: NodeProps) {
  const setSelectedNodeId = useUIStore((s) => s.setSelectedNodeId);

  return (
    <div
      className={`flex items-center gap-2.5 rounded-xl border px-3.5 py-2.5 min-w-[120px] cursor-pointer transition-all
    ...
    >
      ...
      />
      <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-yellow-500/15 text-yellow-500">
